          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-gray-400 text-sm hover:text-white transition duration-300">
                ...
                <a href="tel:+919999999999" className="hover:text-red-500 transition duration-300">+91 9999999999</a>
              </li>
              <li className="flex items-center gap-3 text-gray-400 text-sm hover:text-white transition duration-300">
                <svg className="w-5 h-5 text-red-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@sanjayfabricators.com" className="hover:text-red-500 transition duration-300">info@sanjayfabricators.com</a>
              </li>
            </ul>
          </div>
        </div>
