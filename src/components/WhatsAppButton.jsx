const WhatsAppButton = () => {
  ...
  return (
    <div className="fixed bottom-20 right-5 z-40 flex flex-col space-y-3">
      <a
      ...
      <a
        ...
        className="bg-green-600 hover:bg-green-700 text-white p-3 rounded-full shadow-lg transition duration-300 flex items-center justify-center"
